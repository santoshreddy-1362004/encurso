...
const events = [
  ...
  },
  {
    ...
    icon: '❓',
    img: '/quiz.png',
    desc: 'A challenging technical quiz event designed to test participants\' knowledge in core engineering and technology domains.',
    tag: 'Technical',
    category: 'Technical',
    prize: '₹2,000',
    entryFee: '₹499 / team',
    team: '2-3 members',
    evaluation: [
      'Technical Knowledge – Depth and accuracy of engineering concepts',
      'Problem Solving – Ability to apply concepts to solve technical problems',
      'Speed – Quick and correct responses',

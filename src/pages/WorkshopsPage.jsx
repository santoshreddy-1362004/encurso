...
const workshops = [
  ...
  },
  {
    ...
    img: '/image copy.png',
    instructor: 'Indian Institute of Information Technology, Design and Manufacturing (IIITDM), Kurnool',
    duration: '2 Days (Mar 28-29)',
    venue: 'EEE Dept, UCEK, JNTUK Kakinada',
  ...
  {
    title: 'Hands on workshop on "Li-ion battery packs and EVs"',
    subtitle: 'Powering the future of smart mobility',
    img: '/image copy 2.png',
    instructor: 'EVRETRON ENERGIES INDIA PRIVATE LIMITED, Hyderabad',
    duration: '2 Days (Mar 28-29)',
    venue: 'EEE Dept, UCEK, JNTUK Kakinada',
    ...
    pricing: '1 Member: ₹1000 | 3 Members discount: ₹800 per member',
  ...
  {
    title: 'Hands on workshop on "Digital Controllers"',
    subtitle: 'Build, program, and control real-time embedded systems',
    img: '/image copy 3.png',
    instructor: 'Effectronic Systems Pvt Ltd, Amaravati.',
    duration: '2 Days (Mar 28-29)',
    venue: 'EEE Dept, UCEK, JNTUK Kakinada',
